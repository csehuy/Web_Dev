<nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
        <div class="container">
            <a class="navbar-brand" href="#">
                <img src="./images/logo.jpg" alt="logo" style="height: 40px; width: 40px;">
            </a>
                ...
                <?php 
                    if(($_SESSION) && $_SESSION['role'] == 2){
                        ...
                        <div class="m-2">
                            ...
                            <a class="text-decoration-none" href="./pages/logout.php"><span class="d-none d-sm-inline mx-1 text-primary">Đăng xuất</span></a>
                        </div>
                        ';
                    }
